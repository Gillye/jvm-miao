...
public class BootClassLoader {
     ...
     *
     *  注意路径后面的斜杠不可丢
     *  C:\Users\lancelot\IdeaProjects\jvm-miao\target\classes\com\miao\jvm\example\HelloWorld.class
     */
    private static String searchPath = "C:/Users/lancelot/IdeaProjects/jvm-miao/target/classes/";
    ...
    private static InstanceKlass readAndParse(String name) {
        ...
        // 解析字节码文件
        InstanceKlass klass = ClassFileParser.parserFile(content);
